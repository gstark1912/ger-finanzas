<template>
  <thead>
    <tr>
      ...
      <th v-for="m in months" :key="m.year+'-'+m.month" style="text-align:center;min-width:110px;">
    ...
    <tr>
      ...
      <th v-for="m in months" :key="m.year+'-'+(m.month??m.monthNumber)" style="text-align:center;font-size:11px;color:#7f8c8d;font-weight:400;">
